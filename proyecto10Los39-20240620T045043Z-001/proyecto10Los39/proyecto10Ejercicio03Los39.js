...
rl.question("Numero de terminos deseado: ", (x) => {
    ...
    // Bucle para calcular la serie de Lucas, usamos los primeros numeros y usamos 'k' para guardar temporalmente un numero
    for (number1 = 2, number2 = 1, k = 0, contador = 0; contador < limite; k = number2, number2 = number2 + number1, number1 = k, contador += 1){
